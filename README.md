...
## Απόδοση
Για dataset μεγέθους 10000 σημείων, οι αλγόριθμοι παρουσιάζουν recall@100 > 95%. Ο απλός Vamana χρειάζεται 2' για indexing και οι Filtered, Stitched λίγο παραπάνω από 1'.</br>
...
Για την αντιμετώπιση αυτού του προβλήματος, ως medoid ενός φίλτρου θεωρούμε το αποτέλεσμα της Filtered Greedy Search για το φίλτρο αυτό για k = 1. 
...
- Δεν υπάρχουν πλέον **leaks** στα tests μέσω Valgrind. Μπορείτε να το δείτε εκτελώντας make valgrind_test
- Παρέχονται συναρτήσεις **αποθήκευσης** και διαβάσματος γράφων ως binary αρχεία.
- Παρέχονται **test** για τις συναρτήσεις **Pruning**.
...
- Νίκος Πεντασίλης: Filtered Robust Pruning.
